...
def run_tvb_implementation(
    ...
    # Replace with MontbrioPazoRoxin_broken to verify that dfun differences can be found
    # In that case, switch to a full parameter sweep found in test_parameters.py
