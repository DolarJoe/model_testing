...
from mpr_tvb_vbjax_test import create_meshgrid_linspace, load_data_for_testcase, run_tvb_implementation, run_vbjax_implementation
...
def plot_phase_plane_and_random_points(test_case):
    ...
    for id, res in enumerate(args):
        ...
        axs[id].scatter(*load_data_for_testcase(test_case), color="red")
